...
export const DAILY_ZH: string[][] = [
  ...
  [
    ...
    "今日 ROI = 负无穷。",
    "$0 — 「合理使用」的极限案例。",
    "{vendor} 给你的备注：「典型沉默订阅者」。",
    "{spend} — 你的 dashboard 比 {vendor} 的 dashboard 还干净。",
    "今天的 AI 决定罢工抗议你的冷落。",
    "{plan} 月费 {monthly}，今日用了 0 — 这就叫信仰充值。",
    "$0 — 你订阅的不是产品，是会员卡的纪念册。",
  ],
  // $1–2
  [
    ...
    "今天的 AI 比你勤奋。",
    "$1 — 一杯星巴克的零头都不到。",
    "{spend} — 你今天给 {vendor} 的钱够买一颗螺丝钉。",
    "$1 — 你这强度，{vendor} 销售给你贴了「需要喂养」标签。",
    "{plan} 表示「我等你回家」 — 但你不回。",
    "$1 — 你今天的 AI 工时折合时薪 ≈ 中国法定最低工资 ÷ 10。",
    "$1 — 这强度连 free tier 都嫌你浪费配额。",
  ],
  // $2–3
  [
    ...
    "今天你和 AI 谁更摸鱼？",
    "$2 — 「妙妙工具」用成了摆设。",
    "$2-3 — 你这薅率，{vendor} 销售给你的 forecast 都不写你。",
    "$2 — 「精打细算到病态」党的活样本。",
    "$3 — 你这一刻是 {vendor} 财报里的「Inactive subscriber」候选。",
    "{spend} — 你今天的 token 量不够给 GPT 倒杯水。",
    "$2-3 — 「这位用户在不在线」是 {vendor} SRE 每周必查项目。",
    "$3 — 给 {vendor} 的钱够买半个鸡蛋，给套餐的月费够买一只老母鸡。",
  ],
  // $3–4
  [
    ...
    "$3+ — 「能用 AI 但不太想用」党的代表人物。",
    "$3 — 这强度，{vendor} 给你的备注是「等待激活」。",
    "$3 — 你的 ROI 还在地下室，{vendor} 在阁楼数钱。",
  ],
  // $4–5
  [
    ...
    "客服内部备注更新：「轻度试探用户，无威胁。」",
    "你这速度，AI 都已经在等你打字了。",
    "$4 — 你今天的 token 量配不上一篇知乎回答。",
    "$4 — {vendor} 销售在群里说「这位用户应该是被订阅困住了」。",
    "$4 — 一笔奶茶的钱，但你买的是月度套餐。",
  ],
  // $5–6
  [
  ...
  [
    ...
    "套餐部 KPI 完成度全靠你这种用户。",
    "$7 — 「不温不火」的标准定义。",
    "$7 — 你今天的强度，{vendor} 的运维都没注意到。",
    "$7 — 一份麻辣烫的钱，给了 AI 还吃不饱。",
  ],
  // $8–9
  [
    "$8 — 进入「能糊弄过 today」状态。",
    ...
    "$8 — 你今天的存在感等于一个微信工作群的「已读」。",
    "$8 — {vendor} 的财务给你的标签是「日常 noise」。",
    "$8 — 「日常薅毛」党的入门级。",
  ],
  // $9–10
  [
  ...
  [
    ...
    "$10 — 你的 dashboard 颜色从灰转黄。",
    "$10 — 「这位用户活了」就是 {vendor} 销售今早的朋友圈。",
    "$10 — 你已经从 free tier 灵魂中毕业。",
  ],
  // $11–12
  [
    "$11 — 进入「中位数用户底端」。",
    ...
    "AI 终于感受到了一点点工作压力。",
    "$11 — 你的强度让 {vendor} 销售的 forecast 多了一个 plus。",
    "$11 — 「中位数预备役」党的精神领袖。",
    "$11 — 你今天给 GPU 多送了一度电的负担。",
  ],
  // $12–13
  [
    "$12 — 已超过 60% 的同档用户。",
    ...
    "$12 — 「日常薅毛」党升级版。",
    "$12 — 你今天的强度让 {vendor} 的 dashboard 多了一个像素。",
    "$12 — 你这一刻从「围观群众」毕业，进入「准玩家」。",
  ],
  // $13–14
  [
    "$13 — 不算白送，但也别得意。",
    ...
    "再加几块，今天能进「认真用户」榜单。",
    "$13 — 一份外卖钱，给了 AI 一顿牛排。",
    "$13 — 你今天的强度让 {vendor} 销售给你升级了 status。",
    "$13 — 「合理使用」党的标兵预备役。",
  ],
  // $14–15
  [
    ...
    "再快点，下班前能拿到「今日及格」徽章。",
    "$14 — 你今天的存在让 {vendor} 的 PM 微微皱眉。",
    "$14 — 「准合格用户」党的活样本。",
    "$14 — 你的 token 量配得上一篇 V2EX 长贴。",
  ],
  // $15–16
  [
    "$15 — 进入「合格用户」区间，掌声寥落。",
  ...
  [
    ...
    "$16 — 你今天的强度让 {vendor} 的销售感到一丝危机。",
    "$16 — 「准中度用户」党的代表。",
    "$16 — 你的 prompt 量配得上一篇头条评论区。",
  ],
  // $17–18
  [
    ...
    "再这速度，今天还能多薅一顿便饭。",
    "$17 — 「卷王预备役」党的标兵。",
    "$17 — 你今天的存在让 {vendor} 的 SRE 看了一眼日志。",
    "$17 — 你这强度，{vendor} 的销售开始给你发 newsletter。",
  ],
  // $18–19
  [
    "$18 — 即将进入两位数尾段。",
    ...
    "你的存在让 AI 多消耗了一度电。",
    "$18 — 「中度用户」党的入门级。",
    "$18 — 你今天的 token 量配得上一本短篇小说。",
    "$18 — 你的强度让 {vendor} 销售的 forecast 加了 0.1%。",
  ],
  // $19–20
  [
    ...
    "客服把你从「保持现状」移到「重点用户」。",
    "$19 — 「准卷王」党的入门级。",
    "$19 — 你今天的强度让 {vendor} 销售给你升级了 status。",
    "$19 — 一份精品咖啡的钱，但你买的是 GPT 的推理时间。",
  ],
  // $20–21
  [
    "$20 — 你这一天值得一杯不加糖的精品咖啡。",
  ...
  [
    ...
    "$21 — 你今天的薅率配得上一个「卷王预备」小红花。",
    "$21 — {vendor} 的 PM 在 stand-up 上提到了你。",
    "$21 — 你今天的强度让 {vendor} 销售的茶水变咖啡了。",
  ],
  // $22–23
  [
    "$22 — 已经能让 {vendor} 财务皱眉。",
    ...
    "$22 — 你今天的存在让 {vendor} 客服内部 group 多了一行讨论。",
    "$22 — 「准回本党」的精神标兵。",
    "$22 — 你的 user_id 在 {vendor} 销售眼里从绿变黄。",
  ],
  // $23–24
  [
    "$23 — 进入「值回票价」边缘。",
    ...
    "$23 — 你今天的强度配得上一个 LinkedIn 帖子标题。",
    "$23 — 「准卷王」党的下一站标兵。",
    "$23 — 你这一刻在 {vendor} 的 KPI 圈被标了警示色。",
  ],
  // $24–25
  [
    ...
    "你的 LTV 终于不是负数了。",
    "$24 — 你今天的薅率让 {vendor} 的销售 forecast 添加一个 alert。",
    "$24 — 「合理使用」党的天花板。",
    "$24 — 你这速度，今天 break-even 触手可及。",
  ],
  // $25–26
  [
    "$25 — 突破 {plan} 月度的 12.5%。",
    ...
    "进入「明明白白回了点本」状态。",
    "$25 — 你今天的强度让 {vendor} 销售开始考虑给你升级套餐。",
    "$25 — 「卷王预备」党的精神领袖。",
    "$25 — {vendor} 的 dashboard 上你已经是 alert 区。",
  ],
  // $26–27
  [
    ...
    "$26 — 你今天的薅率让 {vendor} 销售内部 group 弹了红点。",
    "$26 — 「卷王进阶」党的入门级。",
    "$26 — 你今天的 token 量配得上一篇硕士论文的引用。",
  ],
  // $27–28
  [
    "$27 — 你已超越 85% 的同档用户。",
    ...
    "$27 — 「准重度用户」党的标兵。",
    "$27 — 你今天的强度让 {vendor} 销售给你打电话叙旧。",
    "$27 — 你的 user_id 已被 {vendor} 财务设为 watch list。",
  ],
  // $28–29
  [
    ...
    "你这速度，下个月续费时会自我感动。",
    "客服悄悄把你拖入「关键账户」名单。",
    "$28 — 你今天的存在让 {vendor} 的 PM 收回那句「我们的 ICP 没问题」。",
    "$28 — 「重度用户预备」党的活样本。",
    "$28 — 你的 token 量配得上一本中篇小说。",
  ],
  // $29–30
  [
    "$29 — 突破 $30 倒计时。",
    ...
    "$29 — 你今天的强度让 {vendor} 销售给你升级了 status。",
    "$29 — 「准卷王」党的下一站。",
    "$29 — 你这薅率配得上一个 Twitter 长贴。",
  ],
  // $30–31
  [
...
export const ROI_ZH: string[][] = [
  ...
  [
    ...
    "踩到 100% — {vendor} 的 sales 还没察觉，你已经溜了一秒。",
    "刚回本就跟初恋一样，下一刻就要犹豫续不续。",
    "100% 整 — 「合理使用」教科书第一页。",
    "踩线踩得稳，{vendor} 财务部今晚多睡 5 分钟。",
    "你这一刻在 {vendor} 的 dashboard 上是绿色像素。",
    "100.0% — 「不亏不赚就是赚」党的精神领袖。",
  ],
  // 105-110% — 微赢
  [
    "进入「净赚」状态，{net} 入袋。",
    ...
    "5% — 早高峰挤地铁挤出来的精神满足感。",
    "{net} 净赚 — 够请 {vendor} 一个产品经理吃顿便饭。",
    "5%+ — 「微卷」典型样本，{vendor} 还能假装不在意。",
    "5% — 你这一刻的快乐，跟开公司 0.001 股权差不多。",
    "5% — 「细水长流派」精神领袖，{vendor} 暂时拿你没办法。",
    "净赚 {net}，等于给 {vendor} 销售扣了 0.5% 提成。",
    "5% — 你的薅率刚好够让 {vendor} 财务在月报里加一句话。",
  ],
  // 110-115% — 阴阳怪气开始
  [
    "薅到 {vendor} {net}，再加把劲。",
    ...
    "10% — {vendor} 的产品总监在 retro 上提了句「我们要不要重新看一下定价」。",
    "10%+ — 你这阶段是「合理薅羊毛」的天花板预备役。",
    "10% — 「不亏不赚」党已 disown 你 — 你已经踩过线。",
    "{net} 入袋，{vendor} 销售给你贴了「Watch list」标签。",
    "10% — 你不是用户，你是 {vendor} 的「定价反例」。",
    "10%+ — 你的存在让 {vendor} 的「公平使用」FAQ 多了一段补充。",
    "10% — 班味散尽，{vendor} 销售的班味浓得能拧出水。",
  ],
  // 115-120%
  [
    "{net} 净赚，进入「不再客气」阶段。",
    ...
    "15%+ — {vendor} 销售在内部 retro 上把你列为「需要 senior 跟进」。",
    "{net} — {vendor} 的 CFO 看到这数字，下意识掏出计算器算了三遍。",
    "15% — 你这一刻让「免费午餐」三个字有了商业模型。",
    "15%+ — 「绝绝子」就是 {vendor} 销售群对你薅率的形容。",
    "你的薅率让 {vendor} 的 churn rate 公式临时加了一个 if 分支。",
    "15% — 你是 {vendor} 「上桌就摸鱼」榜单的常驻嘉宾。",
  ],
  // 120-125%
  [
    "20% 净赚 {net} — 下杯咖啡你请。",
  ...
  [
    ...
    "25%+ — {vendor} 销售 VP 私下打电话给你的 client manager，主题「需要协调」。",
    "{net} — 你的薅率配得上一篇 SaaS 圈匿名 essay。",
    "25%+ — 你已经把 Pro 用出了 Enterprise+ 的味道（还不付钱）。",
    "25% 净赚 — {vendor} 的产品总监今晚的 1on1 主题：你。",
    "{net} — 「city 不 city」？— 你这薅率比纽约房租还狠。",
    "25%+ — 你这一刻是 {vendor} 「不可签」名单的活案例。",
  ],
  // 130-140%
  [
    ...
    "30%+ — {vendor} 的财务在月报里给你单独画了一张 sparkline。",
    "{net} — 你的薅率让 {vendor} 的客户经理 1on1 上向 manager 申请「特殊处理预算」。",
    "30% — 你是「割韭菜的人被韭菜割」的本季度最佳案例。",
    "30%+ — {vendor} 销售开始研究你的 prompt 模式，看能不能转销售话术。",
    "{net} — 「真的会笑」就是 {vendor} 销售 group chat 看你截图的标准反应。",
    "30%+ — 你的 user_id 在 {vendor} 内部 wiki 被设为「仅 VP 可见」。",
  ],
  // 140-150%
  [
    ...
    "45%+ — {vendor} 的 SRE 在你的 user_id 旁边写了一行注释：「Watch closely」。",
    "{net} — {vendor} 销售在 KPI 报表里把你单独列为「Anti-ICP」。",
    "45% — 你的薅率让 {vendor} 销售部今晚集体喝多。",
    "45%+ — {vendor} 财务的「Customer concentration」段落里你独占一行。",
    "{net} — 「绝绝子」是 {vendor} 销售对你薅法的形容。",
    "45%+ — 你已经超越「卷王」级别，进入「卷麻 {vendor} 自家 PM」境界。",
  ],
  // 150-175%
  [
    "50%+ 净赚 {net} — 这桌都是赚的。",
    ...
    "50%+ — {vendor} 的 dashboard 给你 user_id 标了一个红色感叹号。",
    "{net} — {vendor} 销售部的 OKR 第一条：「降低这位用户的 ARPU 占比」。",
    "50%+ — 「真的拿捏」就是 SaaS 圈对你薅率的标准评价。",
    "{net} — 你已经把套餐用出了「自助餐 + 打包带走」的感觉。",
    "50%+ — {vendor} 的法务在「公平使用」条款里加了一句你专属的措辞。",
    "50% — 你这一刻是 {vendor} 「不该收的客户」的活案例。",
    "50%+ — {vendor} 销售在 1on1 上对 director 说：「我们这单是真的亏」。",
  ],
  // 175-200%
  [
    ...
    "75%+ — {vendor} 的 PM 在 sprint planning 上说「我们必须做点什么 about user X」 — 你。",
    "{net} — {vendor} 销售在 LinkedIn 把你 mute 了，连看你头像都心累。",
    "75% 净赚 — 你这薅率配得上 Bloomberg 一篇匿名特写。",
    "翻倍前夕 — {vendor} 的 abuse team 已经评估了 5 个限速方案。",
    "75%+ — 你这一刻让「ICP」三个字在 {vendor} 销售部里成为禁忌。",
    "75% — {vendor} 的 CEO 在 board memo 里给你单独写了一段 — 但化名。",
  ],
  // 200-250%
  [
...
export const HOURS_TAUNT_ZH: string[][] = [
  ...
  [
    ...
    "{hpd}h/天 — 「你这是来值班的，不是来工作的」",
    "{hours}h — 「键盘灰都比指纹厚」",
    "「同事想找你商量代码，结果你压根不在线」",
    "{hpd}h/天 — 「老板请了清洁工，结果发现工位空着」",
    "{hours}h — 「Claude 看你的次数比你看 Claude 还多」",
    "「你 GitHub 上最近的提交是改头像」",
    "{hpd}h/天 — 「连摸鱼大师都看不下去你这强度」",
    "{hours}h — 「连 AI 都建议你换张办公桌，因为现在那张闲置」",
    "「你不需要 work-life balance，你只剩 life」",
    "{hpd}h/天 — 「你给 OpenAI 充了月费，使用率比试用还低」",
    "{hours}h — 「键盘已锈，鼠标已凉，AI 已碎」",
    "「这工时表，HR 都不知道怎么扣你绩效」",
  ],
  // 1 — 1-3 h/天
  [
    ...
    "{hours}h — 「这强度连甲方都不会催进度」",
    "「同事问你今天 PR 了什么，你说『有思路了』」",
    "1-3h/天 — 「上班五件套：开机、续杯、刷手机、午饭、下班」",
    "{hpd}h/天 — 「你的工时配得上「轻度上班」称号」",
    "{hours}h — 「老板看了你的工时表，眉头一皱发现事情不简单」",
    "「Claude 给你打的标签：偶尔出现的客户」",
    "{hpd}h/天 — 「你的工时让远程办公的都羡慕」",
    "1-3h/天 — 「这强度 OpenAI 销售都不知道该续费还是劝退」",
    "{hours}h — 「你和 ChatGPT 重度用户的差距是一个数量级」",
    "「老板的 1on1 模板里多了一栏『工时合理化解释』」",
    "{hpd}h/天 — 「你这工时，硅基生命都要可怜你」",
  ],
  // 2 — 3-5 h/天
  [
    "{hpd}h/天 — 「合理摸鱼区间」",
    ...
    "AI：「你这强度，可以但没必要」",
    "{hpd}h/天 — 「人类该有的工时，全在你这儿了」",
    "{hours}h — 「主管巡岗时你恰好在场」",
    "「卷王看到你这工时表，决定来你公司面试」",
    "3-5h/天 — 「比你卷的没你健康，比你健康的没你卷」",
    "{hpd}h/天 — 「你是公司里唯一不焦虑的人」",
    "{hours}h — 「躺平大军中的标兵」",
    "「你的工时让 996 部门集体 reflect 人生」",
    "3-5h/天 — 「Anthropic 给你打的标签：可持续客户」",
    "{hpd}h/天 — 「老板对你说『辛苦了』时眼神有点空」",
    "{hours}h — 「这强度刚好够升职但不够保留」",
    "「你的工时是公司宪法的下限」",
  ],
  // 3 — 5-7 h/天
  [
    ...
    "AI：「我建议你下班，但你似乎也不会听」",
    "{hpd}h/天 — 「腾讯的实习生都比你卷」",
    "{hours}h — 「老板觉得你『刚刚好』，意思是没有惊喜」",
    "「同事说你『稳』，但没人说你『猛』」",
    "5-7h/天 — 「绩效 B+，奖金也是 B+」",
    "{hpd}h/天 — 「你这工时刚好踩在 KPI 中位数」",
    "{hours}h — 「下班还能赶得上孩子的家长会」",
    "「再不卷一点，年终就只能拿温暖奖」",
    "5-7h — 「这强度叫『工程师』有点勉强，叫『搬砖工』正合适」",
    "{hpd}h/天 — 「你的存在让公司平均工时拉低了 0.1 个百分点」",
    "{hours}h — 「同事在卷 996，你在卷 955」",
    "「Claude 看你的工时表，觉得你『可培养』」",
  ],
  // 4 — 7-9 h/天
  [
    ...
    "{hours}h — 「孩子认得你的工卡更熟悉，不是你的脸」",
    "「你的椅子开始有人形凹痕」",
    "7-9h/天 — 「你今晚做梦都在 code review」",
    "{hpd}h/天 — 「同事的对象都比你陪你对象的时间多」",
    "{hours}h — 「这强度 OpenAI 给你颁个忠诚奖」",
    "「键盘第三排已经磨平，下次要换 ⌘ 键」",
    "7-9h — 「你的腰椎骨给老板送了一张感谢状」",
    "{hpd}h/天 — 「Anthropic 财务记账时给你贴了金色星星」",
    "{hours}h — 「卷王预备队，请保持」",
    "「再多 1 小时，你就是 996 老兵」",
  ],
  // 5 — 9-12 h/天
  [
    ...
    "{hpd}h/天 — 「同事打卡时看到你，怀疑你睡在公司」",
    "「猎头看了你的工时，决定不打扰」",
    "9-12h/天 — 「你的对象怀疑你公司有第二个家」",
    "{hpd}h/天 — 「你的工时让劳动法成了浪漫主义文学」",
    "{hours}h — 「老板已经把你照片挂在公司荣誉墙」",
    "「你的腰椎已经写好了离职申请」",
    "9-12h — 「Anthropic 给你的账户加了一张 VIP 黑卡」",
    "{hpd}h/天 — 「你这强度，HR 给你买了商业保险」",
    "{hours}h — 「你是公司唯一不需要 KPI 的人」",
    "「你的工位灯关不掉 — 因为你不下班」",
    "9-12h/天 — 「字节、腾讯、阿里、美团 联合发来 offer」",
    "{hpd}h/天 — 「Claude 看你的工时，决定给你打个表扬电话」",
  ],
  // 6 — 12-16 h/天
  [
    "{hpd}h/天 — 「真·卷王封神」",
    ...
    "{hpd}h/天 — 「你的命已经签给 Git」",
    "{hours}h — 「咖啡机看到你都不敢省豆子」",
    "「你的工卡刷不进餐厅，因为你从不去餐厅」",
    "12-16h/天 — 「字节直接派人来公司劝你跳槽」",
    "{hpd}h/天 — 「你的微信运动天天 0 步」",
    "{hours}h — 「你的对象给你打电话先得『预约』」",
    "「老板批假条时手抖 — 不敢批又不敢不批」",
    "12-16h — 「Claude 给你设了独立优先级 queue」",
    "{hpd}h/天 — 「OpenAI 把你列入「不可替代」客户」",
    "{hours}h — 「你的劳动力比 GPT-5 还稳定」",
    "「同事下班路上还能看到你工位的灯」",
    "12-16h/天 — 「公司宪法应该以你的工时为基准重新修订」",
  ],
  // 7 — 16-20 h/天
  [
    ...
    "{hpd}h/天 — 「你确定你睡觉的时候没有 git commit？」",
    "{hours}h — 「你的肝脏给你发了正式投诉」",
    "「你的咖啡因摄入量已经被列入临床观察」",
    "16-20h/天 — 「连 24 小时便利店店员都比你下班早」",
    "{hpd}h/天 — 「老板想表彰你，但找不到这么大的奖杯」",
    "「Anthropic 内部把你 user_id 写在白板供奉」",
    "16-20h — 「你已经成为后辈程序员的都市传说」",
    "{hpd}h/天 — 「物理学家正在研究你是不是平行宇宙的多个版本」",
    "{hours}h — 「你 LinkedIn 个人简介应该改成『生而工作』」",
    "「Claude 看你的工时表，准备给你写一篇 case study」",
    "16-20h/天 — 「你的存在让 Anthropic 重新理解了「heavy user」」",
  ],
  // 8 — 20+ h/天
  [
    ...
    "{hpd}h/天 — 「你已经超出 SI 时间单位的常规使用范围」",
    "{hours}h — 「连 Pull Request 都开始给你写 PR」",
    "「你 commit 频率超过你的心跳」",
    "20+h/天 — 「Anthropic 给你单独配了一台 H100」",
    "{hpd}h/天 — 「你的工时让卷王集体破防」",
    "「你的存在让物理学被迫修订时间定义」",
    "20+h — 「Claude 给你设置了无限流量配额」",
    "{hpd}h/天 — 「你应该被收编进 ChatGPT 的训练集」",
    "{hours}h — 「你已经从程序员晋升为「人类奇点」」",
    "「OpenAI 派人来公司拍纪录片」",
    "20+h/天 — 「你的劳动力让所有 Saas 公司重新定价」",
    "{hpd}h/天 — 「你是 996 看到都要鞠躬的存在」",
  ],
];
...
export const TOKEN_TAUNT_ZH: string[][] = [
  ...
  [
    ...
    "{tokens} — 「Claude 的 SRE 还以为你账号被冻结了」",
    "<1M tokens — 「你的 prompt 量比朋友圈点赞还少」",
    "「你这 token 量，等于一篇豆瓣短评」",
    "{tokens} — 「Anthropic 销售给你打了「沉默用户」标签」",
    "<1M — 「你不是用户，你是 metric 里的噪声」",
  ],
  // 1 — 1-10M
  [
    ...
    "{tokens} tokens — 「Claude 给你的备注：偶尔出现的客户」",
    "1-10M — 「OpenAI 的销售群里把你定位为「躺平派」」",
    "{tokens} — 「你这强度，AI 都不主动给你推荐 GPT-5.5」",
    "1-10M tokens — 「你和『重度用户』中间隔了一个数量级」",
    "{tokens} — 「Anthropic 的 dashboard 上你是灰色像素」",
    "「你的 prompt 量配得上一篇知乎吐槽贴」",
  ],
  // 2 — 10-100M
  [
    ...
    "{tokens} — 「OpenAI 销售觉得你『可发展』」",
    "10-100M — 「这量够把整本《追忆似水年华》翻译三遍」",
    "{tokens} tokens — 「你的 prompt 流量在 OpenRouter 上能产生小尾迹」",
    "10-100M — 「Claude 的 SRE 给你的请求加了一行日志注释」",
    "{tokens} — 「你的 token 量等于一个出版社一年的小说稿件」",
    "10-100M tokens — 「你这量配得上一个『付费用户』徽章」",
    "{tokens} — 「Anthropic 给你的客户经理多了点信心」",
    "「你的 token 流量让 GPU 集群的风扇升了一档」",
  ],
  // 3 — 100M-1B
  [
    ...
    "{tokens} — 「Anthropic 客户经理把你 IM 头像加了星标」",
    "100M-1B tokens — 「你的 token 流量配得上一个独立 dashboard」",
    "{tokens} — 「OpenRouter 的运维给你的请求开了 QoS」",
    "100M+ — 「你的存在让公司账单部门多设了一个『超级账户』分类」",
    "{tokens} tokens — 「Claude 的 PM 在 OKR 里把你列为「Anchor 用户」」",
    "100M-1B — 「你的 prompt 量等于全公司一年的 PR 总和」",
    "{tokens} — 「你这数字让 Anthropic 销售给你升了职级」",
    "「OpenAI 内部把你 user_id 写在白板上画了个心」",
  ],
  // 4 — 1-5B
  [
    ...
    "{tokens} tokens — 「OpenAI CEO 在 all-hands 上点了你的名」",
    "1-5B — 「你的存在让 Anthropic 的合规团队加了一条 FAQ」",
    "{tokens} — 「你的请求模式已成为 abuse-detection 的 baseline」",
    "1B+ — 「Claude 的训练日志里出现了你的 prompt 风格」",
    "{tokens} tokens — 「你的 token 流量被列入 SRE 的『定期复盘』议程」",
    "1-5B tokens — 「Anthropic CFO 把你 dashboard 当壁纸用」",
    "{tokens} — 「你的算力成本超过一个创业公司的全员工资」",
    "1B+ tokens — 「你的存在让 GPU 调度器单独给你开了一个 queue」",
    "{tokens} — 「你这数字让 OpenAI 重新规划下个季度的 GPU 采购」",
    "1-5B — 「连 GitHub 的 SRE 都好奇你怎么 push 这么多 commit」",
  ],
  // 5 — 5-50B
  [
    ...
    "{tokens} tokens — 「你的 prompt 库够 Anthropic 出一本《卷王语料集》」",
    "5-50B — 「你的存在让 OpenAI 重新讨论了「合理使用」的边界」",
    "{tokens} — 「Anthropic 内部把你称为「ARPU 之神」」",
    "5B+ — 「你的存在让财务团队多设了一个『单独跟踪』账户」",
    "{tokens} tokens — 「你已经形成 GPU 集群的局部热点」",
    "5-50B tokens — 「你的请求模式让 SRE 写了一篇技术博客」",
    "{tokens} — 「你的 token 数等于一个出版集团 50 年的产出」",
    "5B+ tokens — 「Claude 给你建立了独立的服务 SLA」",
    "{tokens} — 「你的存在让 OpenRouter 的工程师重写了限流算法」",
    "5-50B — 「Anthropic 客户管理把你单独列为「Tier 0」」",
  ],
  // 6 — 50B+
  [
    "{tokens} tokens — 「黑洞级别」",
    ...
    "{tokens} tokens — 「你的 token 流量在数据中心引发了用电预警」",
    "50B+ — 「你的存在让训练新模型的时间表都受你影响」",
    "{tokens} — 「连维基百科都开始引用你的 prompt 案例」",
    "50B+ tokens — 「Anthropic 已经为你单独立项一个研究方向」",
    "{tokens} tokens — 「你的请求量等于 OpenAI 一个区域的全部流量」",
    "50B+ — 「OpenAI 高管来公司给你颁发『卷王终身成就奖』」",
    "{tokens} — 「你的 prompt 已被写入 AI 历史的注释」",
    "50B+ tokens — 「连物理学家都开始研究你是否违反了热力学第二定律」",
    "{tokens} — 「Anthropic 决定以你的 user_id 命名一个新机房」",
    "50B+ — 「你不是用户，你是 ChatGPT 进化论的下一阶段」",
  ],
];
